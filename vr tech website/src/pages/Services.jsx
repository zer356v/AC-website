...
const Services = () => {
  ...
  const ServiceCard = ({ icon, title, description, features, price, image }) => (
    <Card3D className="h-full rounded-lg">
      <div className="text-center">
        <div className="w-46 h-46 mx-auto mb-4  rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/30 transform group-hover:rotate-12 transition-all duration-500">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-blue-500 mb-4">Complete Climate Solutions</h2>
